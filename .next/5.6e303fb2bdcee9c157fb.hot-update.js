...
function (_Component) {
  ...
  function _default() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      enumerable: true,
      writable: true,
      value: function value(newStationId) {
        _this.setState({
          selectedStationId: _this.state.selectedStationId
        });

        console.log(_this.state.newStationId);
      }
    }), _temp));
  }
...
//# sourceMappingURL=5.6e303fb2bdcee9c157fb.hot-update.js.map