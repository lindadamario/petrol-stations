...
function (_Component) {
  ...
  function _default() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      enumerable: true,
      writable: true,
      value: function value(e, newStationName) {
        var _objectSpread2;

        e.preventDefault();

        _this.setState(_objectSpread({}, _this.state, (_objectSpread2 = {
          selectedStationId: newStationName
        }, _defineProperty(_objectSpread2, "selectedStationId", newStationName), _defineProperty(_objectSpread2, "selectedStationName", newStationName), _defineProperty(_objectSpread2, "selectedStationPrice", newStationName), _defineProperty(_objectSpread2, "selectedStationDiesel", newStationName), _objectSpread2)));
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("div", {
        ...
        return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("li", {
          ...
          onClick: function onClick(e) {
            return _this2.showDetails(e, item.id);
          },
          __source: {
            fileName: _jsxFileName,
            lineNumber: 69
      ...
      }, "petrol Station:"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 79
        }
...
//# sourceMappingURL=5.edb2ea2879d30b9083ac.hot-update.js.map