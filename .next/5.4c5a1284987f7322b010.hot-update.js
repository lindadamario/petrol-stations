...
function (_Component) {
  ...
  function _default() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: function (_value) {
        function value(_x, _x2, _x3, _x4, _x5, _x6) {
        ...
        return value;
      }(function (e, newStationId, newStationName, newStationPrice, newStationDiesel, newStationNinetyFive) {
        e.preventDefault();

        _this.setState(_objectSpread({}, _this.state, _defineProperty({}, key, value)));
  ...
  _createClass(_default, [{
    ...
    value: function () {
      ...
      return function getInitialProps(_x7) {
...
//# sourceMappingURL=5.4c5a1284987f7322b010.hot-update.js.map