...
function (_Component) {
  ...
  function _default() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      enumerable: true,
      writable: true,
      value: function value(e, newStationId, newStationName, newStationPrice, newStationDiesel, newStationNinetyFive, selectedStationLon) {
        e.preventDefault();
        ...
        console.log(_this.state.selectedStationNinetyFive, _this.state.selectedStationDiesel);
      }
    }), _temp));
  }
...
//# sourceMappingURL=5.50782a89e8eb597a27f5.hot-update.js.map